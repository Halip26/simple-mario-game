...
# tentukan konstanta untuk ukuran windows game
WINDOW_WIDTH = 1200
WINDOW_HEIGHT = 600
#atur fps ke 20
FPS = 20
...
# Mengatur backround dengan file yang sudah diberikan
...
class Dragon:
    ...
    def update(self):
        canvas.bit(self.dragon_img, self.dragon_img_rect)
...
# this one for start the mario game
def start_game():
    canvas.fill(BLACK)
...
# disini untuk fungsi check level (1-4)
...
# Kode utama untuk menjalankan game dengan fungsi game_loop
def game_loop():
    while True:
        global dragon
        dragon = Dragon()
